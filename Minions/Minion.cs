...
namespace Rawr.WarlockSim.Minions
{
    /// <summary>
    ...
    /// The rank 8 tooltip shows that it deals 199/223 fire damage @ level 78.
    /// This increases to:
    /// - 201/225 @ level 79,
    /// - 203/227 @ level 80!
    /// </summary>
    public class FireBolt : MinionSpell
    {
        ...
        public override float ExecuteTime()
        {
            return (base.ExecuteTime() - (Character.WarlockTalents.DemonicPower * 0.25f));
        }
    }
